  ...
  try:
    ...
    while True:
      try:
        ...
        joystick = 1 if paddle_x < ball_x else -1 if paddle_x > ball_x else 0
  except HaltError:
    return score
...
class Test13(unittest.TestCase):
  def test_example_1(self):
    self.assertEqual(12345, main('104,1,104,2,104,3,104,6,104,5,104,4,3,50,104,1,104,2,104,3,104,6,104,5,104,4,104,-1,104,0,104,999,104,-1,104,0,104,12345,99'))
